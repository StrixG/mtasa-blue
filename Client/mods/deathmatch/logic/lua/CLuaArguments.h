...
public:
    ...
    bool         ReadFromJSONString(const char* szJSON, bool bArray = false);
    bool         WriteToJSONString(std::string& strJSON, bool bSerialize = false, int flags = JSON_C_TO_STRING_PLAIN, bool bArray = false);
